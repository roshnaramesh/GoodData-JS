...
/* @gooddata/gooddata-js - v11.2.2 */
/* 2019-02-08 09:57:17 */
/* Latest git commit: "1abf6a1" */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var referenceHandling = __webpack_require__(15);
	exports.referenceHandling = referenceHandling;
	var DataLayer = __webpack_require__(127);
	exports.DataLayer = DataLayer;
	var TypeGuards = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var execution_1 = __webpack_require__(96);
	var project_1 = __webpack_require__(13);
	var report_1 = __webpack_require__(114);
	var config_1 = __webpack_require__(115);
	var catalogue_1 = __webpack_require__(116);
	var admin_1 = __webpack_require__(117);
	var attributesMapLoader_1 = __webpack_require__(106);
	var visualizationObjectHelper_1 = __webpack_require__(107);
	/**
	 * # JS SDK
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XhrModule = /** @class */ (function () {
	    ...
	    XhrModule.prototype.head = function (url, settings) {
	        return this.ajax(url, lodash_1.merge({ method: 'HEAD' }, settings));
	    };
	    /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var package_json_1 = __webpack_require__(11);
	/**
	 ...
	 * @private
	 */
	exports.getIn = function (path) { return function (object) { return get(object, path); }; };
	/**
	 * Helper for polling
	 *
	 ...
	 * @private
	 */
	exports.handleHeadPolling = function (xhrHead, uri, isPollingDone, options) {
	    if (options === void 0) { options = {}; }
	    var _a = options.attempts, attempts = _a === void 0 ? 0 : _a, _b = options.maxAttempts, maxAttempts = _b === void 0 ? 50 : _b, _c = options.pollStep, pollStep = _c === void 0 ? 5000 : _c;
	    return xhrHead(uri)
	        .then(function (response) {
	        ...
	        return isPollingDone(response.getHeaders()) ?
	            ...
	            promise_1.delay(pollStep).then(function () {
	                return exports.handleHeadPolling(xhrHead, uri, isPollingDone, __assign({}, options, { attempts: attempts + 1 }));
	            });
	    });
	};
	/**
	...
	function getAllPagesByOffsetLimit(xhr, uri, itemKey, offset, pagesData) {
	    ...
	    return new Promise(function (resolve, reject) {
	        xhr.get(uri + "?offset=" + offset + "&limit=" + PAGE_LIMIT)
	            ...
	            var projects = get(dataObjects, itemKey);
	            var data = pagesData.concat(projects.items);
	            var totalCount = get(projects, 'paging.totalCount', 0);
	...
	var UserModule = /** @class */ (function () {
	    ...
	    UserModule.prototype.getCurrentProfile = function () {
	        return this.xhr.get('/gdc/account/profile/current')
	            .then(function (r) { return r.getData().accountSetting; });
	    };
	    /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectModule = /** @class */ (function () {
	    ...
	    ProjectModule.prototype.getProjects = function (profileId) {
	        return util_1.getAllPagesByOffsetLimit(this.xhr, "/gdc/account/profile/" + profileId + "/projects", 'projects')
	            .then(function (result) { return result.map(function (p) { return p.project; }); });
	    };
	    /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var util_1 = __webpack_require__(7);
	var xhr_1 = __webpack_require__(6);
	var referenceHandling_1 = __webpack_require__(15);
	/**
	...
	var MetadataModule = /** @class */ (function () {
	    ...
	    MetadataModule.prototype.getObjects = function (projectId, objectUris) {
	        ...
	        var promises = objectsUrisChunks.map(function (objectUrisChunk) {
	            ...
	            return _this.xhr.post(uri, { body: body })
	                ...
	                .then(function (result) {
	                return lodash_1.get(result, ['objects', 'items']).map(function (item) {
	    ...
	    MetadataModule.prototype.getObjectsByQuery = function (projectId, options) {
	        ...
	        var query = lodash_1.pick(__assign({ limit: 50 }, options, deprecated), ['category', 'mode', 'author', 'limit', 'deprecated']);
	    ...
	    MetadataModule.prototype.getVisualization = function (uri) {
	        return this.getObjectDetails(uri)
	            .then(function (visualizationObject) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var omit = __webpack_require__(30);
	var isArray = __webpack_require__(21);
	var isObject = __webpack_require__(25);
	var isString = __webpack_require__(85);
	var stringify = __webpack_require__(86);
	var uuid_1 = __webpack_require__(90);
	var uri_1 = __webpack_require__(95);
	/*
	 * Helpers
	 */
	...
	var createConverter = function (conversionFunction) {
	    return function (mdObject, idGenerator) {
	        ...
	        return __assign({}, mdObject, { content: __assign({}, omit(mdObject.content, 'references'), { properties: stringify(convertedProperties) }, referencesProp) });
	    };
	};
	/*
	 * Conversion from References to URIs
	 */
	var convertReferenceToUri = function (references) { return function (value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(31),
	    baseClone = __webpack_require__(32),
	    baseUnset = __webpack_require__(68),
	    castPath = __webpack_require__(69),
	    copyObject = __webpack_require__(47),
	    customOmitClone = __webpack_require__(73),
	    flatRest = __webpack_require__(76),
	    getAllKeysIn = __webpack_require__(60);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stack = __webpack_require__(33),
	    ...
	    baseAssignIn = __webpack_require__(49),
	    cloneBuffer = __webpack_require__(51),
	    copyArray = __webpack_require__(54),
	    copySymbols = __webpack_require__(55),
	    copySymbolsIn = __webpack_require__(57),
	    getAllKeys = __webpack_require__(59),
	    getAllKeysIn = __webpack_require__(60),
	    getTag = __webpack_require__(19),
	    initCloneArray = __webpack_require__(61),
	    initCloneByTag = __webpack_require__(62),
	    initCloneObject = __webpack_require__(63),
	    isArray = __webpack_require__(21),
	    isBuffer = __webpack_require__(27),
	    isMap = __webpack_require__(66),
	    isObject = __webpack_require__(25),
	    isSet = __webpack_require__(67),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var json = typeof JSON !== 'undefined' ? JSON : __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stringify = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	// (C) 2007-2018 GoodData Corporation
	var experimental_executions_1 = __webpack_require__(97);
	var attributesMapLoader_1 = __webpack_require__(106);
	var execute_afm_1 = __webpack_require__(108);
	/**
	 * Execution endpoints
	 *
	 * @module execution
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lodash_1 = __webpack_require__(4);
	var rules_1 = __webpack_require__(104);
	var definitions_1 = __webpack_require__(105);
	var attributesMapLoader_1 = __webpack_require__(106);
	var visualizationObjectHelper_1 = __webpack_require__(107);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
	  var crypt = __webpack_require__(100),
	      utf8 = __webpack_require__(101).utf8,
	      isBuffer = __webpack_require__(102),
	      bin = __webpack_require__(101).bin,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecuteAfmModule = /** @class */ (function () {
	    ...
	    ExecuteAfmModule.prototype.executeAfm = function (projectId, execution) {
	        var _this = this;
	        validateNumOfDimensions(lodash_1.get(execution, 'execution.resultSpec.dimensions').length);
	    ...
	    ExecuteAfmModule.prototype.getPage = function (executionResultUri, limit, offset) {
	        return this.fetchExecutionResult(executionResultUri, limit, offset)
	            .then(function (executionResultWrapper) {
	    ...
	    ExecuteAfmModule.prototype.fetchExecutionResult = function (executionResultUri, limit, offset) {
	        ...
	        return this.xhr.get(uri).then(function (apiResponse) { return apiResponse.response.status === 204
	            ? null
	            : apiResponse.getData(); });
	    };
	...
	function replaceLimitAndOffsetInUri(oldUri, limit, offset) {
	    ...
	    var query = __assign({}, qs.parse(queryPart), { limit: limit.join(','), offset: offset.join(',') });
	...
	function getNextLimit(limit, nextOffset, total) {
	    var numOfDimensions = total.length;
	    validateNumOfDimensions(numOfDimensions);
	    var getSingleNextLimit = function (limit, nextOffset, total) { return nextOffset + limit > total
	        ? total - nextOffset
	        : limit; };
	    ...
	    return lodash_1.range(numOfDimensions).map(function (i) { return getSingleNextLimit(limit[i], nextOffset[i], total[i]); });
	}
	...
	function mergePage(prevExecutionResult, executionResult) {
	    ...
	    if (paging.offset.length === 1) {
	        result.paging.count = [
	            lodash_1.get(result, 'headerItems[0][0]', []).length
	        ];
	    }
	    if (paging.offset.length === 2) {
	        result.paging.count = [
	            lodash_1.get(result, 'headerItems[0][0]', []).length,
	            lodash_1.get(result, 'headerItems[1][0]', []).length
	        ];
	    }
	    return result;
	}
	...
	var ReportModule = /** @class */ (function () {
	    ...
	    ReportModule.prototype.exportResult = function (projectId, executionResult, exportConfig, pollingOptions) {
	        ...
	        return this.xhr.post("/gdc/internal/projects/" + projectId + "/exportResult", { body: requestPayload })
	            .then(function (response) { return response.getData(); })
	            .then(function (data) {
	            return util_1.handleHeadPolling(_this.xhr.head.bind(_this.xhr), data.uri, _this.isDataExported, pollingOptions);
	        });
	    };
	    ReportModule.prototype.isDataExported = function (response) {
	        var taskState = response.status;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	// (C) 2007-2014 GoodData Corporation
	var dataProducts_1 = __webpack_require__(118);
	var domainDataProducts_1 = __webpack_require__(122);
	var domains_1 = __webpack_require__(123);
	var domainSegments_1 = __webpack_require__(121);
	var clients_1 = __webpack_require__(124);
	var segments_1 = __webpack_require__(120);
	var logs_1 = __webpack_require__(125);
	var contracts_1 = __webpack_require__(126);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	// (C) 2007-2018 GoodData Corporation
	var routes_1 = __webpack_require__(119);
	var segments_1 = __webpack_require__(120);
	var domainDataProducts = __webpack_require__(122);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// (C) 2007-2018 GoodData Corporation
	var routes_1 = __webpack_require__(119);
	var domainSegments = __webpack_require__(121);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	// (C) 2007-2018 GoodData Corporation
	var routes = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	// (C) 2007-2018 GoodData Corporation
	var Header = __webpack_require__(128);
	exports.Header = Header;
	var DataSourceUtils = __webpack_require__(129);
	exports.DataSourceUtils = DataSourceUtils;
	var DataSource = __webpack_require__(130);
	exports.DataSource = DataSource;
	var Filters = __webpack_require__(132);
	exports.Filters = Filters;
	var Uri = __webpack_require__(95);
	exports.Uri = Uri;
	var async_1 = __webpack_require__(134);
	exports.createSubject = async_1.createSubject;
	exports.ISubject = async_1.ISubject;
	var toAfmResultSpec_1 = __webpack_require__(167);
	exports.toAfmResultSpec = toAfmResultSpec_1.toAfmResultSpec;
	var ResultSpecUtils = __webpack_require__(176);
	exports.ResultSpecUtils = ResultSpecUtils;
	var AfmUtils = __webpack_require__(177);
	exports.AfmUtils = AfmUtils;
	var DataTable_1 = __webpack_require__(178);
	exports.DataTable = DataTable_1.DataTable;
	var DummyAdapter_1 = __webpack_require__(189);
	exports.DummyAdapter = DummyAdapter_1.DummyAdapter;
	var ExecuteAfmAdapter_1 = __webpack_require__(191);
	exports.ExecuteAfmAdapter = ExecuteAfmAdapter_1.ExecuteAfmAdapter;
	var UriAdapter_1 = __webpack_require__(192);
	exports.UriAdapter = UriAdapter_1.UriAdapter;
	var Adapter_1 = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var stringify = __webpack_require__(86);
	var DataSource_1 = __webpack_require__(131);
	...
	var DataSource = /** @class */ (function () {
	    ...
	    DataSource.prototype.getPage = function (resultSpec, limit, offset) {
	        ...
	        var resultSpecFingerprint = stringify(resultSpec);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isDateFilter(filter) {
	    return !!(filter.absoluteDateFilter
	        || filter.relativeDateFilter);
	}
	function getSelection(filter) {
	    if (filter.positiveAttributeFilter) {
	        return filter.positiveAttributeFilter.in;
	    }
	    if (filter.negativeAttributeFilter) {
	        return filter.negativeAttributeFilter.notIn;
	    }
	    return [];
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseClone = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Subscription_1 = __webpack_require__(142);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rxSubscriber_1 = __webpack_require__(149);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var isArray_1 = __webpack_require__(143);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(137);
	var switchMap_1 = __webpack_require__(156);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var switchMap_1 = __webpack_require__(157);
	/* tslint:enable:max-line-length */
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var subscribeToResult_1 = __webpack_require__(159);
	/* tslint:enable:max-line-length */
	/**
	 * Projects each source value to an Observable which is merged in the output
	 * Observable, emitting values only from the most recently projected Observable.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isPromise_1 = __webpack_require__(161);
	var isObject_1 = __webpack_require__(144);
	var Observable_1 = __webpack_require__(137);
	var iterator_1 = __webpack_require__(162);
	var InnerSubscriber_1 = __webpack_require__(163);
	var observable_1 = __webpack_require__(150);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var catchError_1 = __webpack_require__(166);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	// (C) 2007-2018 GoodData Corporation
	var compact = __webpack_require__(168);
	var flatMap = __webpack_require__(169);
	var get = __webpack_require__(8);
	var typings_1 = __webpack_require__(171);
	var MeasureConverter_1 = __webpack_require__(175);
	...
	function convertAFM(visualizationObject) {
	    var attributes = getAttributes(visualizationObject.buckets).map(convertAttribute);
	    var attrProp = attributes.length ? { attributes: attributes } : {};
	    var measures = getMeasures(visualizationObject.buckets)
	        .map(MeasureConverter_1.default.convertMeasure);
	...
	function convertVisualizationObjectFilter(filter) {
	    ...
	    if (typings_1.VisualizationObject.isAbsoluteDateFilter(filter)) {
	...
	function convertNativeTotals(visObj) {
	    var nativeTotals = flatMap(visObj.buckets, (function (bucket) { return bucket.totals || []; })).filter(function (total) { return total.type === 'nat'; });
	...
	function convertSorting(visObj) {
	    if (visObj.properties) {
	        ...
	        var sorts = get(properties, 'sortItems', []);
	        return sorts ? sorts : [];
	    }
	    return [];
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getFormat(measure) {
	    var definition = measure.measure.definition;
	    var measureFormat = get(measure.measure, 'format');
	    if (typings_1.VisualizationObject.isArithmeticMeasureDefinition(definition)) {
	        if (definition.arithmeticMeasure.operator === 'change') {
	            return '#,##0.00%';
	        }
	    }
	    var predefinedFormat = typings_1.VisualizationObject.isMeasureDefinition(definition)
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var AfmUtils_1 = __webpack_require__(177);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getMeasureDateFilters(normalizedAfm) {
	    return flatMap(normalizedAfm.measures, function (item) {
	...
	function isDateFilterRelative(filter) {
	    return filter && !!filter.relativeDateFilter;
	}
	function isDateFilterAbsolute(filter) {
	    return filter && !!filter.absoluteDateFilter;
	}
	/**
	...
	function appendFilters(afm, attributeFilters, dateFilter) {
	    ...
	    var afmAttributeFilters = afmFilters.filter(function (filter) { return !isDateFilter(filter); });
	    var filters = compact(afmAttributeFilters.concat(attributeFilters, dateFilters));
	    return __assign({}, normalizedAfm, { filters: filters });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var DummyDataSource_1 = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var DataSource_1 = __webpack_require__(130);
	var package_json_1 = __webpack_require__(11);
